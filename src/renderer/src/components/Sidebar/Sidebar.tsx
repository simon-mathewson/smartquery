...
export const Sidebar: React.FC = () => {
  ...
  return (
    <div className="sticky left-0 top-0 z-10 grid h-screen w-[256px] grid-rows-[max-content_max-content_minmax(auto,max-content)] gap-4 bg-gray-50/70 px-4 pt-11 shadow-lg backdrop-blur-lg">
      <div
