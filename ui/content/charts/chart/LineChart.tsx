...
export const LineChart = (props: LineChartProps) => {
  ...
  return (
    <MuiLineChart
      ...
      className="[&_.MuiAreaElement-root]:!fill-[url('#gradient')] [&_.MuiChartsAxis-label_tspan]:fill-textSecondary [&_.MuiChartsAxis-label_tspan]:text-xs [&_.MuiChartsAxis-line]:!stroke-border [&_.MuiChartsAxis-tickLabel]:!fill-textSecondary [&_.MuiChartsAxis-tick]:!stroke-border [&_.MuiLineElement-root]:!stroke-blue-600 dark:[&_.MuiLineElement-root]:!stroke-blue-500"
    >
      <defs>
