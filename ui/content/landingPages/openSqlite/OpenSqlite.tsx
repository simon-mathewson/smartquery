...
export const OpenSqlite: React.FC = () => {
  const [, navigate] = useLocation();

  const title = 'Open SQLite';
  const description =
    'Open your SQLite database right here in your browser and explore it with an intuitive UI and an AI copilot.';
