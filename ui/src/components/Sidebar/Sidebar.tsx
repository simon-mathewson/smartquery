...
export const Sidebar: React.FC = () => {
  ...
  return (
    <div className="grid h-screen grid-rows-[max-content_max-content_minmax(auto,max-content)] gap-2 border-r border-r-gray-200 bg-gray-50/80 px-2 pt-2 backdrop-blur-lg">
      <div
